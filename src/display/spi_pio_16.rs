...
pub struct SpiPioInterfaceMultiBit<RS, P: PIOExt, SM1: StateMachineIndex, SM2: StateMachineIndex> {
...
impl<RS, P, SM1, SM2> SpiPioInterfaceMultiBit<RS, P, SM1, SM2>
where
    P: PIOExt,
...
impl<RS, P, SM1, SM2> WriteOnlyDataCommand for SpiPioInterfaceMultiBit<RS, P, SM1, SM2>
where
    P: PIOExt,
    SM1: StateMachineIndex,
    SM2: StateMachineIndex,
...
fn send_data<RS, P, SM1, SM2>(
    iface: &mut SpiPioInterfaceMultiBit<RS, P, SM1, SM2>,
    words: DataFormat<'_>,
) -> Result
where
    P: PIOExt,
